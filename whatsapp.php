...
class Whatsapp extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Contact us by whatsapp');
    ...
    */
    ...
    {
        $this->context->smarty->assign('number', Configuration::get('WHATSAPP_NUMBER'));
